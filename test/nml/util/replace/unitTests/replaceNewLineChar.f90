module test_nmlUtil_unitTests_replace_newLineChar
    ...
    implicit none
    private
    public :: replNLChar_should_return_string_that_replaces_char_with_mark

contains
    subroutine replNLChar_should_return_string_that_replaces_char_with_mark(error)
        implicit none
        ...
        actual_namelist = replace_new_line_char(str_namelist)
    ...
    contains
        ...
        subroutine setup(str_namelist, expected_namelist)
            ...
            str_namelist = "&namelist_group_name input1=1 "//new_line(" ")//"input2=10 "//new_line(" ")//"input3=4 /"
            expected_namelist = "&namelist_group_name input1=1 \ninput2=10 \ninput3=4 /"
    ...
    end subroutine replNLChar_should_return_string_that_replaces_char_with_mark
end module test_nmlUtil_unitTests_replace_newLineChar
