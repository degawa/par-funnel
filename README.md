...
Unit test frameworks for Fortran mentioned above do not provide parameterization of unit tests, only use Fortran standard features, and do not support optional arguments. This library, par-funnel, aims to provide features that
